<template>
  ...
  <div class="mainImageDiv">
    <img class="mainImage" alt="메인 이미지" :src="coupleInfo.coupleImgUrl" />
  </div>
  <!-- 프로필 -->
  <div class="profileGroup">
    ...
    /></RouterLink>
    <img class="heart" alt="♥" src="/static/img/heart-suit.png" />
  ...
  <!-- 디데이 -->
  <div class="DdayGroup">
    <div class="maskingTape">
      <div class="ddayText">D+{{ coupleDday }}</div>
    </div>
  </div>
</template>
