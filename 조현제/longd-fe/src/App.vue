  ...
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a
          class="navbar-brand nav-icon"
          href="http://www.docs.openvidu.io/en/stable/tutorials/openvidu-recording-java/"
          title="Documentation"
          target="_blank"
        >
    ...
    <div id="session" style="display: none">
      <div id="session-header">
        ...
        <input
          ...
          id="forceValue"
          type="text"
          @keyup="checkBtnsForce()"
        />
        <input
          class="btn btn-sm"
          type="button"
          id="buttonForceUnpublish"
          @mouseup="forceUnpublish()"
...
const startRecording = function () {
  var outputMode = document.querySelector(
  ...
  Api.post('recording/start', {
    ...
    console.log(`forceRecordingId : ${res.data.id}`, session.value.sessionId);

    checkBtnsRecordings();
    document.getElementById('textarea-http').textContent = JSON.stringify(
      res.data,
      null,
      '\t',
    );
...
const listRecordings = function () {
  Api.get('recording/list', {}).then(res => {
    console.log(res);
    textareaHttp.value = JSON.stringify(res.data, null, '\t');
  });
};
